...
public class StockmanOutStockAfter extends JPanel implements Watched,
		ActionListener {
	int frameWidth;
	int frameHeight;
	JLabel[] jl;
	...
	public StockmanOutStockAfter(int frameWidth, int frameHeight) {
	...
	private void init() {
		...
		jl[8].setBounds(frameWidth / 2, frameHeight / 10 * 7, 100, 65);
